# Compatibility alias for Docker - see Containerfile
# This file is identical to Containerfile
# For multi-architecture builds (amd64 + arm64), use Containerfile.cross instead:
#   docker buildx build --platform linux/amd64,linux/arm64 -f Containerfile.cross .
