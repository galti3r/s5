...
host_key_path = "/tmp/s5-e2e-reload-key"
...
"##
    ...
    let config: s5::config::types::AppConfig = toml::from_str(&config_content).unwrap();
...
[server]
ssh_listen = "127.0.0.1:0"
host_key_path = "/tmp/s5-e2e-reload-key2"
...
[server]
ssh_listen = "127.0.0.1:0"
host_key_path = "/tmp/s5-e2e-reload-key3"
