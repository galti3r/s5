...
async fn test_ssh_password_auth_success() {
    ...
    let ok = handle
        ...
        .await
        .unwrap();
    assert!(ok, "password auth should succeed");
}
...
async fn test_ssh_password_auth_failure() {
    ...
    let ok = handle
        ...
        .await
        .unwrap();
    assert!(!ok, "wrong password should fail");
}
...
async fn test_ssh_unknown_user_rejected() {
    ...
    let ok = handle
        ...
        .await
        .unwrap();
    assert!(!ok, "unknown user should be rejected");
}
...
async fn test_ssh_auth_retry_then_success() {
    ...
    let ok = handle
        ...
        .await
        .unwrap();
    assert!(ok, "correct password should succeed after a failure");
}
