...
pub fn bastion_preset(username: &str, password_hash: &str) -> String {
    format!(
        r##"# s5 bastion preset — high security, deny-default
[server]
ssh_listen = "0.0.0.0:2222"
host_key_path = "host_key"
server_id = "SSH-2.0-s5_{version}"
...
pub fn proxy_preset(username: &str, password_hash: &str) -> String {
    format!(
        r##"# s5 proxy preset — permissive forwarding proxy
[server]
ssh_listen = "0.0.0.0:2222"
socks5_listen = "0.0.0.0:1080"
host_key_path = "host_key"
server_id = "SSH-2.0-s5_{version}"
banner = "Welcome to s5 proxy"
dns_cache_ttl = 300
connect_retry = 2
...
pub fn dev_preset(username: &str, password_hash: &str) -> String {
    format!(
        r##"# s5 dev preset — development and testing
[server]
