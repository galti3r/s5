...
pub fn build_demo_config(
    ...
    AppConfig {
        server: ServerConfig {
            ...
            host_key_path: std::path::PathBuf::from("/tmp/s5-demo-host-key"),
            server_id: "SSH-2.0-s5-demo".to_string(),
            banner: "Welcome to s5 demo".to_string(),
            motd_path: None,
