...
#[derive(Parser, Debug)]
#[command(name = "s5", version, about = "Lightweight SSH + SOCKS5 proxy server")]
pub struct Cli {
    /// Path to configuration file (also settable via S5_CONFIG env var)
    #[arg(short, long, default_value = "config.toml", env = "S5_CONFIG")]
    pub config: PathBuf,
